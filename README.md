# Satisfactory-AB_MiscDecoMod
The development source for the Satisfactory mod AB_MiscDecoMod
...
Given how important files are ignored you'll need to re-export fbxs from blender and images from substance/affinity as you change the sources, but the uassets in the content folders should already be cached and work fine.
